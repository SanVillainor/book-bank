      ...
      <div className="flex h-full w-full py-10">
        ...
        <div className="px-5 w-1/2">
          ...
          <div className="flex justify-between py-2">
            <button className="text-xl font-medium py-2 bg-green-300 rounded-xl px-4" onClick={clickHandler}>
              Add to Collection
            </button>
            <button className="text-xl font-medium py-2 bg-green-300 rounded-xl px-4" onClick={()=>addToWishlist()}>
              Add to wishlist
            </button>
            <button className="text-xl font-medium py-2 bg-green-300 rounded-xl px-4" onClick={()=>addToReadBooks()}>
